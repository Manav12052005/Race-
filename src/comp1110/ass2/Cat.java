...
//        System.out.println(destY+ " " + destX);
        ...
        while (!queue.isEmpty()) {
            ...
            for (int[] direction : directions) {
                ...
                if (newY >= 0 && newY < height && newX >= 0 && newX < width
                        && !visited[newY][newX] &&
                        (isCharNotFire(tiles[newY][newX]) || tiles[newY][newX] == 'w' || tiles[newY][newX] == 'W')) {
...
//                    System.out.println(newY + " " + newX);
    ...
    public static boolean isCharNotFire(char c) {
        return c == 'b' || c == 'g' || c == 'p' || c == 'r' || c == 'y' || c == 'B' || c == 'G' || c == 'P' || c == 'R' || c == 'Y';
    }
}
